...
import java.util.Timer // timer library for delay
import kotlin.concurrent.schedule // schedule library to set delay time
...
class MainActivityTest {
    ...
    fun initValidString() {
        ...
        myScoreButton = R.id.increase
        myStealButton = R.id.decrease
...
//        textView.check(matches(withText("4")))
        ...
        // the test check the score too fast after the screen rotate,
        // therefore a small delay is necessary for the app to load the score and let the test check it
